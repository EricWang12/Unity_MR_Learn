...
public class getObjFIle : MonoBehaviour
{
    // Start is called before the first frame update
    private Mesh holderMesh;
    public Material material;
    private GameObject loadedObject;
    public string fileName = "/prediction.obj";
    void Start()
    {

        //Mesh holderMesh = new Mesh();
        //ObjImporter newMesh = new ObjImporter();
        //holderMesh = newMesh.ImportFile("./prediction.obj");

        //MeshRenderer renderer = gameObject.AddComponent<MeshRenderer>();
        //MeshFilter filter = gameObject.AddComponent<MeshFilter>();
        //renderer.material = material;
        //filter.mesh = holderMesh;
        //holderMesh = FastObjImporter.Instance.ImportFile("./prediction.obj");
        //MeshRenderer renderer = gameObject.AddComponent<MeshRenderer>();
        //MeshFilter filter = gameObject.AddComponent<MeshFilter>();
        //filter.mesh = holderMesh;
    ...
    void Update()
    {
        Graphics.DrawMesh(holderMesh, Vector3.zero, Quaternion.identity, material, 0);
    }
    ...
    public void CreateCube()
    {
        ...
        else
        {
            ...
            loadedObject = GameObject.CreatePrimitive(PrimitiveType.Cube);// objLoader.Load(Path.Combine(Application.streamingAssetsPath , "prediction.obj"));
            loadedObject.transform.position = new Vector3(0, 0.1f, 0.6f);
            loadedObject.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
            MeshRenderer renderer = gameObject.AddComponent<MeshRenderer>();
            MeshFilter filter = gameObject.AddComponent<MeshFilter>();
            //renderer = this.GetComponent<MeshRenderer>();
            //renderer.material = material;
            NearInteractionGrabbable grabbable = loadedObject.AddComponent<NearInteractionGrabbable>();
            ManipulationHandler manipulationHandler = loadedObject.AddComponent<ManipulationHandler>();
    ...
    public void Create()
    {
        ...
        else
        {
            ...
            //loadedObject = objLoader.Load(Path.Combine(Application.streamingAssetsPath , "prediction.obj"));
            var www = new WWW("https://people.sc.fsu.edu/~jburkardt/data/obj/lamp.obj");
            while (!www.isDone)
                System.Threading.Thread.Sleep(1);
            loadedObject = objLoader.Load(new MemoryStream());
            loadedObject.transform.position = new Vector3(0.5f, 0.1f, 0.6f);
            loadedObject.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
            MeshRenderer renderer = gameObject.AddComponent<MeshRenderer>();
            MeshFilter filter = gameObject.AddComponent<MeshFilter>();
            //renderer = this.GetComponent<MeshRenderer>();
